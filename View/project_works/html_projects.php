				...
				<div class="row portfolio-grid justify-content-center">
					<div class="col-lg-4 col-md-6 all latest">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="portfolio-details.html">Gate Pass Management System</a></h4>
								<p>Live Pass Generate</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 all popular">
						<div class="portfolio_box">
							...
							<div class="short_info">
								<h4><a href="portfolio-details.html">Life care & Research Center Management System</a></h4>
								<p>Diagnosis Center Work Paper less.</p>
							</div>
						</div>
					</div>
					<!-- <div class="col-lg-4 col-md-6 all latest">
