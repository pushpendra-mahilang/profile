        ...
        <div class="container">
            <div class="row justify-content-start align-items-center">
                <div class="col-lg-5 "   >
                    <div >
                        <!-- class="about_img" -->
                        <img style="width:100%;height:100%;" class="" src="<?php echo $imageurl;?>about-us.jpg" alt="">
                ...
                <div class="offset-lg-1 col-lg-5">
                    <div class="main_title text-left">
                        ...
                        <p>
                            My objective is to leverage my academic knowledge, technical skills, and innovative mindset to
 pursue a dynamic career in the field of computer science. I aim to contribute effectively to the
 development of cutting-edge software solutions, utilizing emerging technologies and best practices.
                        </p>
                ...
                <div class="offset-lg-2 col-lg-4 col-md-6">
                    <div class="client-info">
                        <div class="d-flex mb-50">
                            ...
                            <span class="smll">Month Experience Working</span>
                        </div>
